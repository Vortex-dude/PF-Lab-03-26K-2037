# PF-Lab-03-26K-2037
**Name:** Choudhry Zoraiz Qadir  
**Roll Number:** 26K-2037  
...
### Topics Covered in C programming are:
- Variables and data types
- Operators ( arithmetic, relational, logical)
- Conditional statements (if, else if, switch)
- Loops (for, while, do-while)
- Input/output functions ( printf, scanf)
- Basic debugging and syntax rules

> "The only way to learn a new programming language is by writing programs in it." — Dennis Ritchie

You can check even/odd using the expression `num % 2 == 0`.

- [x] Set up the repository and initialize Git
- [x] Write and test Task 1
- [x] Write and test Task 2
- [ ] Write and test Task 3
